    ...
    <div className="bg-white min-h-full pb-24">
      ...
      <div className="relative h-64">
        ...
        <div className="absolute bottom-6 px-6 text-white">
          <h1 className="text-3xl font-bold">{booking.courtDetails?.sporttype || "Match"}</h1>
      ...
      <div className="p-6 space-y-6">
        <div className="bg-white border rounded-2xl p-5 shadow-sm space-y-4">
          <div className="flex items-center gap-3 text-slate-600"><MapPin className="text-gray-400" size={20}/> <span className="font-semibold text-sm">{booking.courtDetails?.location}</span></div>
          <div className="flex items-center gap-3 text-slate-600"><Calendar className="text-gray-400" size={20}/> <span className="font-semibold text-sm">{booking.start} - {booking.end}</span></div>
